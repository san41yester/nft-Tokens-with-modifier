...
contract SampleToken {
    ...
    modifier checkequalname(string name) {
    ...
    function createtoken(string name, uint speed) public checkequalname(name){
    ...
    function changeSpeed(uint tokenId, uint speed) public  checkOwnerAndAccept(tokenId) {
         
        tokensArr[tokenId].speed = speed;
        
    }

    function tokenforsale(uint tokenId, uint price) public  checkOwnerAndAccept(tokenId) {
